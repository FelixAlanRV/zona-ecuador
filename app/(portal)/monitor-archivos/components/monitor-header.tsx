...
interface MonitorHeaderProps {
  table: Table<MonitorArchivo> | null
}

export function MonitorHeader({ table }: MonitorHeaderProps) {

  const canalRecepcionFilter = filterFields.find(f => f.id === "canalRecepcion")
  ...
  return (
    <div className="space-y-4 rounded-lg bg-white px-6 pt-6">
      ...
      <div className="flex items-center gap-4 mt-8 flex-wrap">
        ...
        {table && canalRecepcionFilter && (
          <div className="flex items-center gap-2">
            <DataTableFacetedFilter
              column={table.getColumn("canalRecepcion")}
              title={canalRecepcionFilter.label}
              options={canalRecepcionFilter.options || []}
            />
          </div>
        )}
        ...
        <div className="flex flex-1 items-center gap-2 min-w-[300px]">
          <div className="relative flex-1">
            ...
            <Input
              placeholder="Buscar por TrackId, Identificador..."
              className="pl-9"
